...
class childMinding : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ArrayAdapter.createFromResource(this, R.array.dropdown_CM,                           //(see How to Implement Spinner in Android - Codes Easy, 2023)
            ...
            btnBack6.setOnClickListener {
                ...
                Toast.makeText(this@childMinding, "Loading", Toast.LENGTH_SHORT)
                    .show()                                                                         //(IIE, 2024)
