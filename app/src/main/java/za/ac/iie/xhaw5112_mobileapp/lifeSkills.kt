...
class lifeSkills : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ArrayAdapter.createFromResource(this,
            R.array.dropdown_LS, android.R.layout.simple_spinner_item).also { adapter ->            //(see How to Implement Spinner in Android - Codes Easy, 2023)
        ...
        btnBack4.setOnClickListener {
            ...
            Toast.makeText(this@lifeSkills, "Loading", Toast.LENGTH_SHORT)
                .show()                                                                             //(IIE, 2024)
