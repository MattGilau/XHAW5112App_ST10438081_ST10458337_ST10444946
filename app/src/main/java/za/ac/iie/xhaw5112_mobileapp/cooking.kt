...
class cooking : AppCompatActivity() {
    ...
    private lateinit var btnBack5: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ArrayAdapter.createFromResource(this, R.array.dropdown_C,                            //(see How to Implement Spinner in Android - Codes Easy, 2023)
            ...
            btnBack5.setOnClickListener {
                ...
                Toast.makeText(this@cooking, "Loading", Toast.LENGTH_SHORT)
                    .show()                                                                             //(IIE, 2024)

                // Explicit intent to specify the Activity class should be started
                val intent = Intent(
                    this,
                    shortCoursesSummary::class.java
                )                        //(IIE, 2024)
